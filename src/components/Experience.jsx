...
const Experience = ({ onClose }) => {
    const experienceData = [
        ...
        {title: "Software Developer", 
            company:"University of Toronto", 
            time:"2025.01 – 04", 
         description:"I built a synchronized, web-based audio control system using HTML, CSS, and JavaScript to align audio snippets with slide content. I also created an autoplay engine that streamlined slide navigation by 50%, optimized performance for mobile devices through reduced file sizes, and ensured full accessibility with screen-reader compatibility.", 
        },
        {title: "UI/UX Tester", 
            company:"Tech Valet", 
        ...
        {title: "Software Developer", 
            company:"Mhapy", 
            time:"2024.01 – 04", 
         description:"Lead a team of 7 to develop a Django API integrated with a BERT model that converts unstructured survey text into quantifiable insights, reducing processing time by 40%. I designed the backend architecture and PostgreSQL schema to visualize assessment trends, and improved API reliability through comprehensive Postman testing and cloud deployment on Railway", 
        },
